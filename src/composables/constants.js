...
export const SKILL_SPECIALIZATION_OPTIONS = {
  artCraft: ["表演", "绘画", "雕刻", "摄影", "写作", "舞蹈", "乐器"],
  languageOther: ["英语", "法语", "德语", "拉丁语", "汉语", "日语"],
  pilot: ["飞行器", "船"],
  science: ["化学", "物理", "生物学", "药学", "数学", "地质学", "天文学"],
  firearmsHandgun: ["左轮手枪", "半自动手枪", "冲锋枪", "信号枪"],
  firearmsRifle: ["步枪", "霰弹枪", "弓", "弩"],
  fightingBrawl: ["斗殴", "剑", "斧", "矛", "鞭", "链枷", "绞具"],
  survival: ["沙漠", "极地", "海上", "森林", "岛屿"],
};
